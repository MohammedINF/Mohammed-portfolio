...
const resources = {
  en: {
    translation: {
      ...
      typewriterWords: ['Websites', 'Mobile Applications', 'Database Systems'],
      ...
      buttonWriting: ['Hire Me !', 'Contact Me !'],
  ...
  kr: {
    translation: {
      ...
      typewriterWords: [' وێبسایتەکان ', ' ئەپەکانی مۆبایل ', ' سیستەمە داتابەیس '],
      ...
      buttonWriting: ['من دامەزرێنە ! ', ' پەیوەندیم پێوەبکە ! '],
      myName: 'محمد عوسمان',
  ...
  ar: {
    translation: {
      ...
      typewriterWords: [' المواقع الإلكترونية ', ' تطبيقات الهاتف المحمول ', ' أنظمة قواعد البيانات '],
