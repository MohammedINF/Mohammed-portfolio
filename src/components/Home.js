                    ...
                    <div id='Home' className='bg-gradient-to-r from-gray-950 to-gray-800 p-5 container mx-auto   h-fit '>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between fixed z-50">
                            <div className="flex gap-2 items-center justify-between">
                                <div className="flex gap-2 items-center">
                                    <img alt="logo" className='rounded-full w-11 h-11' loading="lazy" decoding="async" data-nimg="1" src={require('../icons/M.png')} />
                                    <h1 className='text-white  font-medium font-hamaFont text-xl'>Mohammed</h1>
                                </div>
                            </div>
                        </div>
                                ...
                                <motion.nav initial={{ x: 100, opacity: 0 }}
                                    ...
                                    <motion.ul variants={{
                                        ...
                                        <motion.li className={`text-[#8032e0] font-hamaFont hover:bg-[#8032e0] ${i18n.language === 'en' && 'bg-[#8032e0] text-white rounded-lg'} pt-[1px] pb-[1px] pl-[3px] pr-[3px] hover:text-white transition-all duration-150 ease-in-out hover:rounded-lg`}>
                                            <button value='en' className='flex gap-x-3' onClick={(e) => changeLanguage(e.target.value)} > English <img width="20" height="20" src="https://img.icons8.com/color/48/great-britain.png" alt="great-britain" /></button>
                                        </motion.li>
                                        ...
                                        <motion.li className={`text-[#8032e0] mt-1 font-custom ${i18n.language === 'kr' && 'bg-[#8032e0] text-white rounded-lg'} pt-[1px] pb-[1px] pl-[3px] pr-[3px] hover:bg-[#8032e0] hover:text-white transition-all duration-150 ease-in-out hover:rounded-lg`}>
                                            <button value='kr' className='flex gap-x-5' onClick={(e) => changeLanguage(e.target.value)}> کوردی <img width="20" height="20" src="https://img.icons8.com/color/48/kurdistan.png" alt="kurdistan" /></button>
                                        </motion.li>
                                        ...
                                        <motion.li className={`text-[#8032e0] mt-1 font-Arabic hover:bg-[#8032e0] ${i18n.language === 'ar' && 'bg-[#8032e0] text-white rounded-lg'} pt-[1px] pb-[1px] pl-[3px] pr-[3px] hover:text-white transition-all duration-150 ease-in-out hover:rounded-lg`} >
                                            <button value='ar' className='flex gap-x-[19px]' onClick={(e) => changeLanguage(e.target.value)}> العربیة <img width="20" height="20" src="https://img.icons8.com/color/48/iraq.png" alt="iraq" /></button>
                                        </motion.li>
                        ...
                        <div className=' flex flex-col md:flex-row justify-between overflow-y-auto '>
                            ...
                            <motion.div initial={{ x: -100, opacity: 0 }}
                                ...
                                <h1 className={`text-2xl text-white ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'}  lg:text-4xl font-medium`}>{t('developerName')} <span className={`text-purple-500 ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'}`}> {t('position')} </span>{t('location')}</h1>
                                <h4 className={`text-lg  ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'} text-zinc-400 font-medium`}>{t('created')} <span className='text-purple-500 text-lg font-medium'><Typewriter words={t('typewriterWords', { returnObjects: true })} typeSpeed={50} cursorStyle='|' cursor deleteSpeed={150} loop /></span></h4>
                                <blockquote className={`p-4 w-full flex my-4 ${i18n.language === 'en' ? 'border-l-4' : 'border-r-4'}  border-gray-300 `}>
                                    ...
                                    <h4 className={` mt-4 text-zinc-400 ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'} text-md md:text-lg lg:w-[700px] md:w-[400px] w-96 `}>{t('speech')}
                                ...
                                <a href="#0" onClick={scrollToContacts} class={`relative  text-white ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'} border-purple-500  w-max items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold  group`}>
                                    <span class="w-32 h-32 rotate-45 translate-x-12 -translate-y-2 absolute left-0 top-0 bg-white opacity-[3%]"></span>
                                    <span class="absolute top-0 left-0 w-48 h-48 -mt-1 transition-all duration-500 ease-in-out rotate-45 -translate-x-56 -translate-y-24 bg-white opacity-100 group-hover:-translate-x-8"></span>
                                    <span class="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-gray-900"><Typewriter words={t('buttonWriting', { returnObjects: true })} cursor cursorStyle='|' typeSpeed={50} deleteSpeed={150} loop /></span>
                            ...
                            <motion.div initial={{ y: -100, opacity: 0 }}
                                ...
                                <img alt='' loading="lazy" width="450" height="450" decoding="async" data-nimg="1" className={` object-contain ${i18n.language === 'en' ? 'scale-x-100' : '-scale-x-100'}  relative  mx-auto grayscale`} src={require('../icons/mohammed1cp.png')} />
                                ...
                                }} className="bg-brand-700  border border-white p-1 pr-2 pl-2 flex items-center gap-2 relative  w-full centered-bottom">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-5 gap-y-10 mt-5">
                            {cards.map((data, i) => (
                                ...
                                <motion.div initial={{ opacity: 0, scale: 0.6 }}
                                    ...
                                    transition={{ type: "spring", bounce: 0.5, delay: i * 0.2 }} style={{ boxShadow: '5px 5px 0px 0px rgb(168 85 247)' }} className="border-[3px]   border-purple-500 rounded-lg flex flex-col h-max">
                                    <div className='w-10 h-10 absolute z-20 mx-auto   -mt-5 rounded-full bg-white/20 '>
                                    <img className='w-8 h-8 mx-[4px] my-[4px]' src={data.icon} alt=''/>
                                    </div>
                                    <motion.div initial={{ opacity: 0, scale: 0.6 }}
                                        animate={{ opacity: 1, scale: 1, }}
                                        transition={{ type: "spring", bounce: 0.5, delay: i * 0.2 }} className="w-full h-[200px] relative">
                                    ...
                                    <div>
                                        <h2 className={`border-b-[2.3px] border-purple-500 ml-4 mr-4 p-3 ${i18n.language === 'en' ? 'font-hamaFont' : 'font-custom'} justify-center flex text-white text-2xl`}>{data.title}</h2>
                        ...
                        <footer className="flex mb-14 lg:mb-4 flex-row justify-between items-center">
                            <div>
                                <div className="flex flex-col lg:flex-col gap-2 items-center">
                                    <div className="flex gap-2 items-center">
                                        <img alt="logo" loading="lazy" className='sm:w-[50px] sm:h-[50px] mb-2 md:mb-0 h-[40px] w-[40px]' decoding="async" data-nimg="1" src={require('../icons/M.png')} />
                                        <h1 className=' font-hamaFont text-white'>Mohammed</h1></div>
                                </div>
                            </div>

                            <div className="flex mt-0 lg:mt-0 gap-3 items-center">

                                <a className='text-zinc-400 hover:text-white' href="https://github.com/MohammedINF">
                                    <motion.svg initial={{ opacity: 0, scale: 0.6 }}
                                        whileInView={{ opacity: 1, scale: 1 }}
                                        transition={{ type: "spring", bounce: 0.5, }} whileHover={{ scale: 1.5 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="github" fill="currentColor" x="0px" y="0px" height="27" width="27">
                                ...
                                <a className='text-zinc-400 hover:text-white' href="https://t.snapchat.com/egK0xHD0">
                                    <motion.svg initial={{ opacity: 0, scale: 0.6 }}
                                        whileInView={{ opacity: 1, scale: 1 }}
                                ...
                                <a className='text-zinc-400 hover:text-white' href="https://www.facebook.com/profile.php?id=100010818873982&mibextid=ZbWKwL">
                                    <motion.svg initial={{ opacity: 0, scale: 0.6 }}
                                        ...
                                        <path d="M12.001,2.002c-5.522,0-9.999,4.477-9.999,9.999c0,4.99,3.656,9.126,8.437,9.879v-6.988h-2.54v-2.891h2.54V9.798	c0-2.508,1.493-3.891,3.776-3.891c1.094,0,2.24,0.195,2.24,0.195v2.459h-1.264c-1.24,0-1.628,0.772-1.628,1.563v1.875h2.771	l-0.443,2.891h-2.328v6.988C18.344,21.129,22,16.992,22,12.001C22,6.479,17.523,2.002,12.001,2.002z"></path></motion.svg></a>
